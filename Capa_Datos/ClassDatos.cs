...
namespace Capa_Datos
{
    public class ClassDatos
    {
        ...
        public DataTable D_Buscar_Autor(ClassEntidad obje)
        {
            SqlCommand cmd = new SqlCommand("sp_buscar_autor",cn);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            String accion = "";
            SqlCommand cmd = new SqlCommand("sp_manteniminiento_clientes",cn);
            cmd.CommandType = CommandType.StoredProcedure;
